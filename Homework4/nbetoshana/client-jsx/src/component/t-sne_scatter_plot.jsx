...
export default function TSNEPlot({ selectedStock }) {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:8000/tsne_all/")
      .then((res) => res.json())
      .then((data) => {
      ...
      points.selectAll("circle")
        ...
        .attr("cx", d => x(d.x))
        .attr("cy", d => y(d.y))
        .attr("r", d => d.Stock === selectedStock ? 7 : 4)
        .attr("fill", d => color(d.sector || "Tech"))
        .attr("opacity", 0.8)
      ...
      const labels = points.selectAll("text")
        ...
        .style("font-weight", d => d.Stock === selectedStock ? "bold" : "normal")
